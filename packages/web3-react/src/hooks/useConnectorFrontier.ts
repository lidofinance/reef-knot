...
import { hasInjected, isFrontierProvider } from '../helpers';
...
const WALLET_URL = 'https://www.frontier.xyz/browser-extension/';

export const useConnectorFrontier = (
  ...
  const connect = useCallback(async () => {
    ...
    if (hasInjected() && isFrontierProvider()) {
      await disconnect();
